...
public class HygieiaPublisherStub extends HygieiaPublisher {
    ...
    public static class HygieiaTestStub extends HygieiaTest {
        public HygieiaTestStub (boolean publishTestStart, boolean publishEvenBuildFails, String testFileNamePattern, String CustodianResultsDirectory, String testType, String applicationName, String environmentName) {
            super(publishTestStart, publishEvenBuildFails, testFileNamePattern, CustodianResultsDirectory, testType, applicationName, environmentName);
        }
    }
}
